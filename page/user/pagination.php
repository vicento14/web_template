...
<?php include 'plugins/sidebar/pagination_bar.php';?>
            ...
            <div class="card-body">
              <div class="row mb-2">
                ...
                <div class="col-lg-6 col-sm-3">
                  ...
                  <button class="btn btn-primary" id="searchReqBtn" onclick="search_accounts(1, 0)">Search <i class="fas fa-search"></i></button>
                  </div> 
                </div>
              </div>
